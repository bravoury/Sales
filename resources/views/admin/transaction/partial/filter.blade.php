<div class="btn-group sales-transaction">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order_id]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.order_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[debt]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.debt')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[debt]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[note]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.note')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order_fee]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.order_fee')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[pay_fee]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.pay_fee')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[pay_fee]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[code]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.code')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[transport_fee]" class="col-sm-2 control-label">
                                        {!! trans('sales::transaction.label.transport_fee')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[transport_fee]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".sales-transaction .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/sales.transaction.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".sales-transaction .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.sales-transaction .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'sales.transaction.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#sales-transaction-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#sales-transaction-list .btn-reset-filter').css('display', 'none');
