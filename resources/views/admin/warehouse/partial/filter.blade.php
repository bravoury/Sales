<div class="btn-group sales-warehouse">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[origin_kg_fee]" class="col-sm-2 control-label">
                                        {!! trans('sales::warehouse.label.origin_kg_fee')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[origin_kg_fee]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".sales-warehouse .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/sales.warehouse.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".sales-warehouse .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.sales-warehouse .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'sales.warehouse.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#sales-warehouse-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#sales-warehouse-list .btn-reset-filter').css('display', 'none');
