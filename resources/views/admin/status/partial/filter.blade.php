<div class="btn-group sales-status">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[desc]" class="col-sm-2 control-label">
                                        {!! trans('sales::status.label.desc')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[desc]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order]" class="col-sm-2 control-label">
                                        {!! trans('sales::status.label.order')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".sales-status .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/sales.status.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".sales-status .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.sales-status .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'sales.status.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#sales-status-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#sales-status-list .btn-reset-filter').css('display', 'none');
