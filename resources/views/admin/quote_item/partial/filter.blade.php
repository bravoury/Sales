<div class="btn-group sales-quote_item">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.name')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[image]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.image')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[qty]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.qty')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[options]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.options')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[price_web]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.price_web')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[comment]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.comment')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[note]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.note')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[total_fee]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.total_fee')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[checked]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.checked')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[total_web]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.total_web')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[total_exchange]" class="col-sm-2 control-label">
                                        {!! trans('sales::quote_item.label.total_exchange')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".sales-quote_item .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/sales.quote_item.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".sales-quote_item .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.sales-quote_item .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'sales.quote_item.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#sales-quote_item-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#sales-quote_item-list .btn-reset-filter').css('display', 'none');
