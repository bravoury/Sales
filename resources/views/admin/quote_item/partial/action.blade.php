                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu item" role="menu">
                            ...
                            data-title='Add Task'  data-url="{{guard_url('sales/quote_item/action/task/'.$quote_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-tasks" aria-hidden="true"></i> Add Task</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Add Calendar'  data-url="{{guard_url('sales/quote_item/action/calendar/'.$quote_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-calendar" aria-hidden="true"></i> Add Calendar</a></li>
                            <li class="divider"></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/quote_item/action/print/'.$quote_item->getRouteKey())}}"><i class="fa fa-fw fa-print" aria-hidden="true"></i> Print</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/quote_item/action/pdf/'.$quote_item->getRouteKey())}}"><i class="fa fa-fw fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/quote_item/action/excel/'.$quote_item->getRouteKey())}}"><i class="fa fa-fw fa-file-excel-o" aria-hidden="true"></i> Download Excel</a></li>
                            <li class="divider"></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send mail to contact' data-url="{{guard_url('sales/quote_item/action/mail/'.$quote_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-envelope-o" aria-hidden="true"></i> Send Mail</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send SMS to contact' data-url="{{guard_url('sales/quote_item/action/sms/'.$quote_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-comment-o" aria-hidden="true"></i> Send SMS</a></li>
                            <li class="divider"></li>

                            <li><a class="action-clone" style="cursor:pointer;" data-method="GET" data-title="Clone" data-text="Do you want to duplicate this data?" data-url="{{guard_url('sales/quote_item/action/copy/'.$quote_item->getRouteKey())}}"><i class="fa fa-fw fa-clone" aria-hidden="true"></i> Clone</a></li>

                            <li><a class="action-method" data-method="POST" data-title="Archive" data-text="Do you want to change the status of this data?" data-url="{{guard_url('sales/quote_item/action/status/archive/'.$quote_item->getRouteKey())}}" style="cursor:pointer;"><i class="fa fa-fw fa-archive" aria-hidden="true"></i> Archive</a></li>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #dd4b39; color: #fff;">
                                    ...
                                    <div class="popup_description">For {{$quote_item->name}}</div>
                                </div>
        ...
        swal({
            ...
            $.ajax({
                ...
                success:function(data, textStatus, jqXHR)
                {
                    ...
                    $('#sales-quote_item-entry').html(data);
                }
            });
        });      
    });
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success:function(data, textStatus, jqXHR)
                    {
                        ...
                        $('#sales-quote_item-list').DataTable().ajax.reload( null, false );
                        arrayids = [];
                    },
...
@php
  $revisions    = $quote_item->revisionHistory;
@endphp
