<div class="btn-group sales-order_item">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[order_id]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.order_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.name')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[image]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.image')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[link]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.link')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[link]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[note]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.note')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[comment]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.comment')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[qty]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.qty')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[qty]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[price_web]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.price_web')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[price_web]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[total_web]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.total_web')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[total_web]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[total_exchange]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.total_exchange')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[total_exchange]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ship_in_china]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.ship_in_china')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ship_in_china]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[options]" class="col-sm-2 control-label">
                                        {!! trans('sales::order_item.label.options')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[options]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".sales-order_item .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/sales.order_item.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".sales-order_item .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.sales-order_item .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'sales.order_item.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#sales-order_item-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#sales-order_item-list .btn-reset-filter').css('display', 'none');
