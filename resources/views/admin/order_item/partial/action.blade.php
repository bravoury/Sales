                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu item" role="menu">
                            ...
                            data-title='Add Task'  data-url="{{guard_url('sales/order_item/action/task/'.$order_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-tasks" aria-hidden="true"></i> Add Task</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Add Calendar'  data-url="{{guard_url('sales/order_item/action/calendar/'.$order_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-calendar" aria-hidden="true"></i> Add Calendar</a></li>
                            <li class="divider"></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/order_item/action/print/'.$order_item->getRouteKey())}}"><i class="fa fa-fw fa-print" aria-hidden="true"></i> Print</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/order_item/action/pdf/'.$order_item->getRouteKey())}}"><i class="fa fa-fw fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('sales/order_item/action/excel/'.$order_item->getRouteKey())}}"><i class="fa fa-fw fa-file-excel-o" aria-hidden="true"></i> Download Excel</a></li>
                            <li class="divider"></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send mail to contact' data-url="{{guard_url('sales/order_item/action/mail/'.$order_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-envelope-o" aria-hidden="true"></i> Send Mail</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send SMS to contact' data-url="{{guard_url('sales/order_item/action/sms/'.$order_item->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-comment-o" aria-hidden="true"></i> Send SMS</a></li>
                            <li class="divider"></li>

                            <li><a class="action-clone" style="cursor:pointer;" data-method="GET" data-title="Clone" data-text="Do you want to duplicate this data?" data-url="{{guard_url('sales/order_item/action/copy/'.$order_item->getRouteKey())}}"><i class="fa fa-fw fa-clone" aria-hidden="true"></i> Clone</a></li>

                            <li><a class="action-method" data-method="POST" data-title="Archive" data-text="Do you want to change the status of this data?" data-url="{{guard_url('sales/order_item/action/status/archive/'.$order_item->getRouteKey())}}" style="cursor:pointer;"><i class="fa fa-fw fa-archive" aria-hidden="true"></i> Archive</a></li>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #dd4b39; color: #fff;">
                                    ...
                                    <div class="popup_description">For {{$order_item->name}}</div>
                                </div>
        ...
        swal({
            ...
            $.ajax({
                ...
                success:function(data, textStatus, jqXHR)
                {
                    ...
                    $('#sales-order_item-entry').html(data);
                }
            });
        });      
    });
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success:function(data, textStatus, jqXHR)
                    {
                        ...
                        $('#sales-order_item-list').DataTable().ajax.reload( null, false );
                        arrayids = [];
                    },
...
@php
  $revisions    = $order_item->revisionHistory;
@endphp
