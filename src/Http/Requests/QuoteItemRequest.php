...
namespace Tadascript\Sales\Http\Requests;
...
class QuoteItemRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('quote_item');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access quote_item module,
    ...
    {
        return user()->canDo('sales.quote_item.view');
    }
}
